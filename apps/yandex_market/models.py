...
class Product(models.Model):
    ...
    category = models.ForeignKey(Category, on_delete=models.SET_NULL, null=True, db_index=True,
                                 related_name='products')  # Foreign key to Category model
    ...
    parse_detail = models.BooleanField(default=False,
                                       db_index=True)  # To indicate if the product details have been parsed
    ...
    is_processing = models.BooleanField(default=False,
                                        db_index=True)  # To indicate if the product is currently being processed
    is_related_parsed = models.BooleanField(default=False,
                                            db_index=True)  # To indicate if related products have been parsed
...
class Review(models.Model):
    ...
    user_name = models.CharField(max_length=255, null=True, blank=True,
                                 db_index=True)  # User's name who wrote the review
